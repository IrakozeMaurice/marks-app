    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="width: 80%;margin:auto;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            ...
            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                online student marks application.
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://auca.ac.rw/online-registration/" target="_blank"
                  class="underline text-gray-900 dark:text-white">Online registration</a>
              </div>
            </div>

            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                connect to Auca online registration software.
              </div>
            </div>
          </div>
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://online.auca.ac.rw/"
                  target="_blank"
                  class="underline text-gray-900 dark:text-white">e-Learning</a></div>
            </div>

            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                Auca e-Learning platform.
              </div>
            </div>
          </div>
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                <a href="https://auca.ac.rw/" class="underline dark:text-white" target="_blank">About auca</a>
              </div>
            </div>

            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                visit Auca website for more information.
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
        <div class="text-center text-sm text-gray-500 sm:text-left">
          <div class="flex items-center">
            <span class="text-dark" style="color: black;">Made with &nbsp;</span>
            <span class="bg-dark text-white" style="color: black;background: white;">
            ...
            <span class="mr-2" style="color: black;">&nbsp;&nbsp;&nbsp;&nbsp;By&nbsp;</span>
            <a href="https://github.com/IrakozeMaurice" class="ml-1 underline" style="color: black;">
              Irakoze Maurice
            </a>
          </div>
        </div>
